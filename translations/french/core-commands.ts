...
export const translations: Translations = {
	strings: {
		...
		"Error: You must be a Global ${groupName} (or higher) to search for a battle.": "Le serveur demande un rang de ${groupName} ou plus haut pour chercher un match.",
		...
		"Error: You must be a Global ${groupName} (or higher) to challenge users.": "Ce serveur demande d'être au moins ${groupName} ou plus pour envoyer des challenges aux autres utilisateurs.",

...
export const translations: Translations = {
	strings: {
		...
		"Error: You must be a Global ${groupName} (or higher) to search for a battle.": "Dieser Server erfordert es, Rang ${groupName} oder höher zu sein, um nach Kämpfen zu suchen.",
		...
		"Error: You must be a Global ${groupName} (or higher) to challenge users.": "Dieser Server erfordert es, Rang ${groupName} oder höher zu sein, um Nutzer herauszufordern.",

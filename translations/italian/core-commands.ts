...
export const translations: Translations = {
	strings: {
		...
		"Error: You must be a Global ${groupName} (or higher) to search for a battle.": "In questo server è necessario possedere il rank ${groupName} o superiore per cercare una lotta.",
		...
		"Error: You must be a Global ${groupName} (or higher) to challenge users.": "In questo server è necessario possedere il rank ${groupName} o superiore per sfidare gli utenti.",

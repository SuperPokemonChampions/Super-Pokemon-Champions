...
export const translations: Translations = {
	strings: {
		...
		"Error: You must be a Global ${groupName} (or higher) to search for a battle.": "このサーバーでは、バトルを検索するためにはランクが${groupName}以上であることが必要です。",
		...
		"Error: You must be a Global ${groupName} (or higher) to challenge users.": "このサーバーでは、ユーザーにchallengeするためにはランクが${groupName}以上であることが必要です。",

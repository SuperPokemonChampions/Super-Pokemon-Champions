...
export const translations: Translations = {
	strings: {
		...
		"Error: You must be a Global ${groupName} (or higher) to search for a battle.": "Este servidor requer que você tenha o rank ${groupName} ou maior para procurar por uma batalha.",
		...
		"Error: You must be a Global ${groupName} (or higher) to challenge users.": "Este servidor requer que você tenha o rank ${groupName} ou maior para desafiar alguém.",

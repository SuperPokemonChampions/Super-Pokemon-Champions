...
export const translations: Translations = {
	strings: {
		...
		"Error: You must be a Global ${groupName} (or higher) to search for a battle.": "Este servidor requiere que tu rango sea ${groupName} o mayor para buscar una batalla.",
		...
		"Error: You must be a Global ${groupName} (or higher) to challenge users.": "Este servidor requiere que tu rango sea ${groupName} o mayor para retar usuarios.",
